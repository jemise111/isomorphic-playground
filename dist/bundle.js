...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tweetList = __webpack_require__(181);
	...
	var _createTweet = __webpack_require__(183);

	var _createTweet2 = _interopRequireDefault(_createTweet);

	var _tweetActions = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (initialState) {
	  return function () {
	    ...
	    switch (action.type) {
	      case _tweetActions.ADD_TWEET:
	        var tweet = action.tweet;

	        if (tweet) {
	          var tweets = state.tweets.map(function (tweet) {
	            return Object.assign({}, tweet);
	          });
	          tweets.push(_extends({ id: tweets.length + 1 }, tweet));
